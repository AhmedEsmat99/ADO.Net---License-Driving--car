...
namespace licence
{
    public partial class Form1 : Form
    {
        ...
        private void OpenChildForm(Form childForm, object btnSender)
        {
            ...
            this.panelDescktop.Controls.Add(childForm);
            this.panelDescktop.Tag = childForm;
        ...
        {
            OpenChildForm(new Forms.FormCarLicenses(), sender);
            Ltitle.Text = "رخص السيارات";
        }

        private void button2_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.AddCars(), sender);
            Ltitle.Text = "اضافه سيارة";
        }

        private void button3_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.FormDriversLicenses(), sender);
            Ltitle.Text = "رخص السائقين";
        }

        private void button4_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.CRUD_Driver() , sender);
            Ltitle.Text = "اضافه سائق";
        }
